...
<head>
  ...
  <style>
    ...
    .box {
      ...
      position: relative;
      text-align: center;
      background-color: #a20000; /* Update background color */
      border-radius: 10px;
    ...
    <div class="main">
      <div class="box" id="box">
        <div id="text">
          ...
          <p>
            <h3 class="centered-text">Link dagaya with phone number</h3>
            <br>
            <h6>🔢 Enter your number with country code. DAGAYA WEB PAIR</h6>
            <div class="input-container">
              <input placeholder="+94704xxxxxx" type="number" id="number" placeholder="❗ Enter your phone number with country code, DAGAYA WEB PAIR" name="">
              <button id="submit">Submit DAGAYA</button>
            </div>
